...
RUN mkdir -p /run/php/
RUN apk update \
    && apk --no-cache add nginx php-fpm php php-common php-gd php-curl php-intl php-xsl php-mbstring php-zip php-bcmath php-iconv php-soap php7-pear php7-dev supervisor alpine-sdk openssl-dev php-json \
    && rm -rf /var/cache/apk/*
